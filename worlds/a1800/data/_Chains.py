...
_a1800_chains: list[A1800Chain] = [
    ...
    ### EMPIRE_OF_THE_SKIES                                                                                      ###
    ################################################################################################################
    A1800Chain("Aluminium Profiles", {DLC.EMPIRE_OF_THE_SKIES, DLC.NEW_WORLD_RISING}, Region.NW, 1351,
    ...
    ### NEW_WORLD_RISING                                                                                         ###
    ################################################################################################################
    A1800Chain("Sewing Machines (Aluminium)", DLC.NEW_WORLD_RISING, Region.NW, 6623,
               {("Charcoal Kiln", Region.NW), ("Bauxite Mine", Region.NW), ("Aluminium Smelter", Region.NW),
                ("Lumberjack's Hut", Region.NW), ("Sewing Machine Factory", Region.NW)}),
    A1800Chain("Ballsports", DLC.NEW_WORLD_RISING, Region.NW, 5806,
               {("Caoutchouc Plantation", Region.NW), ("Nandu Farm", Region.NW), ("Ball Manufactory", Region.NW)}),
    A1800Chain("Mezcal", DLC.NEW_WORLD_RISING, Region.NW, 6610,
               {("Herb Garden", Region.NW), ("Sugar Cane Plantation", Region.NW), ("Sugar Refinery", Region.NW),
                ("Orchard: Citrus", Region.NW), ("Mezcal Bar", Region.NW)}),
    A1800Chain("Jalea", DLC.NEW_WORLD_RISING, Region.NW, 5813,
               {("Corn Farm", Region.NW), ("Herb Garden", Region.NW), ("Calamari Fishery", Region.NW),
                ("Jalea Kitchen", Region.NW)}),
    A1800Chain("Electricity (Artistas)", DLC.NEW_WORLD_RISING, Region.NW, 7305,
               {("Oil Refinery", Region.NW), ("Rails", Region.NW), ("Small Oil Harbour", Region.NW),
                ("Oil Store", Region.NW), ("Power Station", Region.NW)}),
    A1800Chain("Ice Cream", DLC.NEW_WORLD_RISING, Region.NW, 5465,
               {("Orchard: Citrus", Region.NW), ("Sugar Cane Plantation", Region.NW), ("Sugar Refinery", Region.NW),
                ("Cocoa Plantation", Region.NW), ("Chocolate Factory", Region.NW), ("Power Station", Region.NW),
                ("Cattle Farm", Region.NW), ("Ice Cream Factory", Region.NW)}),
    A1800Chain("Perfumes", DLC.NEW_WORLD_RISING, Region.NW, 5811,
               {("Orchard: Coconut Oil", Region.NW), ("Corn Farm", Region.NW), ("Lumberjack's Hut", Region.NW),
                ("Chemical Plant: Ethanol", Region.NW), ("Orchid Farm", Region.NW), ("Perfume Mixer", Region.NW)}),
    A1800Chain("Samba School", DLC.NEW_WORLD_RISING, Region.NW, 5940,
               {("Power Station", Region.NW), ("Nandu Farm", Region.NW), ("Alpaca Farm", Region.NW),
                ("Mineral Mine", Region.NW), ("Laboratory: Pigments", Region.NW), ("Cotton Plantation", Region.NW),
                ("Cotton Mill", Region.NW), ("Costume Shop", Region.NW), ("Samba School", Region.NW)}),
    A1800Chain("Fire Department", DLC.NEW_WORLD_RISING, Region.NW, 7300,
               {("Caoutchouc Plantation", Region.NW), ("Charcoal Kiln", Region.NW), ("Iron Mine", Region.NW),
                ("Furnace", Region.NW), ("Laboratory: Fire Extinguishers", Region.NW), ("Fire Department", Region.NW)}),
    A1800Chain("Fans", DLC.NEW_WORLD_RISING, Region.NW, 5808,
               {("Charcoal Kiln", Region.NW), ("Bauxite Mine", Region.NW), ("Aluminium Smelter", Region.NW),
                ("Charcoal Kiln", Region.NW), ("Iron Mine", Region.NW), ("Furnace", Region.NW),
                ("Chemical Plant: Ethanol", Region.NW), ("Orchard: Camphor Wax", Region.NW),
                ("Cotton Plantation", Region.NW), ("Chemical Plant: Celluloid", Region.NW),
                ("Caoutchouc Plantation", Region.NW), ("Copper Mine", Region.OW), ("Cable Factory", Region.NW),
                ("Motor Assembly Plant", Region.NW), ("Fan Factory", Region.NW)}),
    A1800Chain("Cinema", DLC.NEW_WORLD_RISING, Region.NW, 5939,
               {("Chemical Plant: Ethanol", Region.NW), ("Orchard: Camphor Wax", Region.NW),
                ("Cotton Plantation", Region.NW), ("Chemical Plant: Celluloid", Region.NW),
                ("Power Station", Region.NW), ("Alpaca Farm", Region.NW), ("Chemical Plant: Film Reels", Region.NW),
                ("Cinema", Region.NW)}),
    A1800Chain("Police Headquarters", DLC.NEW_WORLD_RISING, Region.NW, 7301,
               {("Cotton Plantation", Region.NW), ("Cotton Mill", Region.NW), ("Charcoal Kiln", Region.NW),
                ("Iron Mine", Region.NW), ("Furnace", Region.NW), ("Lumberjack's Hut", Region.NW),
                ("Arsenal: Police Equipment", Region.NW), ("Police Headquarters", Region.NW)}),
    A1800Chain("Scooters", DLC.NEW_WORLD_RISING, Region.NW, 5823,
               {("Caoutchouc Plantation", Region.NW), ("Charcoal Kiln", Region.NW), ("Iron Mine", Region.NW),
                ("Furnace", Region.NW), ("Chemical Plant: Ethanol", Region.NW), ("Orchard: Camphor Wax", Region.NW),
                ("Cotton Plantation", Region.NW), ("Chemical Plant: Celluloid", Region.NW),
                ("Caoutchouc Plantation", Region.NW), ("Copper Mine", Region.OW), ("Cable Factory", Region.NW),
                ("Motor Assembly Plant", Region.NW), ("Power Station", Region.NW), ("Alpaca Farm", Region.NW),
                ("Mineral Mine", Region.NW), ("Laboratory: Pigments", Region.NW), ("Scooter Factory", Region.NW)}),
    A1800Chain("City Hospital", DLC.NEW_WORLD_RISING, Region.NW, 7303,
               {("Corn Farm", Region.NW), ("Lumberjack's Hut", Region.NW), ("Chemical Plant: Ethanol", Region.NW),
                ("Orchid Farm", Region.NW), ("Herb Garden", Region.NW), ("Laboratory: Medicine", Region.NW),
                ("City Hospital", Region.NW)}),
]

...
_a1800_products: list[A1800Product] = [
    ...
    A1800Product("Low-Volume Trade", DLC.VANILLA, ALL_REGIONS, 0, ProductType.META),
    A1800Product("Expeditions: Level 2", DLC.VANILLA, ALL_REGIONS, 0, ProductType.META),
    A1800Product("Medium-Volume Transport", DLC.VANILLA, ALL_REGIONS, 0, ProductType.META),
    ...
    A1800Product("High-Volume Transport", DLC.VANILLA, ALL_REGIONS, 0, ProductType.META),
    ...
    A1800Product("Medium-Volume Trade", DLC.VANILLA, Region.OW, 0, ProductType.META),
    A1800Product("Pier", DLC.VANILLA, Region.OW, 0, ProductType.META),
    ...
    A1800Product("High-Volume Trade", DLC.VANILLA, Region.OW, 0, ProductType.META),
    ...
    A1800Product("Medium-Volume Trade", DLC.VANILLA, Region.NW, 0, ProductType.META),
    A1800Product("Pier", DLC.VANILLA, Region.NW, 0, ProductType.META),
    A1800Product("Grand Storage", DLC.VANILLA, Region.NW, 0, ProductType.META),
    A1800Product("High-Volume Trade", DLC.VANILLA, Region.NW, 0, ProductType.META),
    ...
    A1800Product("Medium Plateau Storage", DLC.THE_PASSAGE, Region.AR, 0, ProductType.META),
    A1800Product("Pier", DLC.THE_PASSAGE, Region.AR, 0, ProductType.META),
    A1800Product("Medium-Volume Trade", DLC.THE_PASSAGE, Region.AR, 0, ProductType.META),
    A1800Product("Large Storage", DLC.THE_PASSAGE, Region.AR, 0, ProductType.META),
    A1800Product("Large Plateau Storage", DLC.THE_PASSAGE, Region.AR, 0, ProductType.META),
    A1800Product("High-Volume Trade", DLC.THE_PASSAGE, Region.AR, 0, ProductType.META),
    ...
    A1800Product("Medium-Volume Trade", DLC.LAND_OF_LIONS, Region.EN, 0, ProductType.META),
    A1800Product("Pier", DLC.LAND_OF_LIONS, Region.EN, 0, ProductType.META),
    ...
    A1800Product("High-Volume Trade", DLC.LAND_OF_LIONS, Region.EN, 0, ProductType.META),
